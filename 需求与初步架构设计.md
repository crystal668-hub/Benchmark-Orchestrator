...
- Benchmark：`verifier-grounded-benchmark==0.7.0`
...
| version / source tag | `0.7.0` / `v0.7.0` |
| source commit | `40c309cdd68e22ec984783f2cbe222da0dc9fdf5` |
| wheel | `verifier_grounded_benchmark-0.7.0-py3-none-any.whl`，`185456` bytes |
| wheel SHA256 | `2cae374f7d5f3b5a2b4724a4360ebb9b1ccbb8eb1040baca590984b84caa8711` |
...
| `property_calculation` | `verifier_grounded_property_calculation` | 20 | 180 秒 |
| `property_calculation_easy` | `verifier_grounded_property_calculation_easy` | 51 | 180 秒 |

0.7.0 新增 property calculation easy 正式 track，并保留正式 scoring profile。
...
1. GUI 只能创建 OpenClaw skills-on/off + VGB 四个 dataset 的 Run；
