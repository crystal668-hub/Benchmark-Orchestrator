...
flowchart LR
    ...
    VS --> VGB["verifier-grounded-benchmark 0.5.0"]
...
当前 pin 为 `verifier-grounded-benchmark==0.5.0`，wheel SHA256 为
`fb99d63fef0fd45a43ed8a074be93c7963c947ec2e371fe27b84a52fc5bdb98e`。该 release 的正式 track 使用
