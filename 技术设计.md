...
当前 OpenClaw release pin 已同步为 `verifier-grounded-benchmark==0.5.0`：source tag `v0.5.0`、
source commit `0a9523176efb84e9d37163caf99bf7509789e823`、wheel SHA256
`fb99d63fef0fd45a43ed8a074be93c7963c947ec2e371fe27b84a52fc5bdb98e`。隔离 runtime 已验证三个
track 的版本均为 `0.5.0`，prompt 数量为 14/14/20。该 release 使用 `linear_goal_v2` 和 package
...
```json
{
  ...
  "vgb_release": {
    "version": "0.5.0",
    "wheel_sha256": "fb99d63fef0fd45a43ed8a074be93c7963c947ec2e371fe27b84a52fc5bdb98e"
  },
  "checks": []
}
```
...
契约 fixture/export helper；VGB capability fixture 必须匹配当前 `release.json` 的 `0.5.0` 和 wheel
