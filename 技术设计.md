...
当前 OpenClaw release pin 已同步为 `verifier-grounded-benchmark==0.7.0`：source tag `v0.7.0`、
source commit `40c309cdd68e22ec984783f2cbe222da0dc9fdf5`、wheel SHA256
`2cae374f7d5f3b5a2b4724a4360ebb9b1ccbb8eb1040baca590984b84caa8711`。隔离 runtime 已验证四个
track 的版本均为 `0.7.0`，prompt 数量为 14/20/20/51。该 release 使用 `linear_goal_v2` 和 package
...
```json
{
  ...
  "datasets": [
    {"id": "verifier_grounded_rdkit", "task_count": 14},
    {"id": "verifier_grounded_xtb_xyz", "task_count": 20},
    {"id": "verifier_grounded_property_calculation", "task_count": 20},
    {"id": "verifier_grounded_property_calculation_easy", "task_count": 51}
  ],
  "thinking_levels": ["off", "minimal", "low", "medium", "high", "xhigh"],
  "default_model": "qwen3.5-plus",
  "vgb_release": {
    "version": "0.7.0",
    "wheel_sha256": "2cae374f7d5f3b5a2b4724a4360ebb9b1ccbb8eb1040baca590984b84caa8711"
  },
  "checks": []
}
```
...
契约 fixture/export helper；VGB capability fixture 必须匹配当前 `release.json` 的 `0.7.0` 和 wheel
